...
void main() {
  ...
  // Adjusted slightly cooler/bluer to match ice theme
  vec3 hue = mix(vec3(0.2, 0.4, 0.9), vec3(0.0, 1.0, 1.0), (uv.y - sin(u_time)) * 0.5);
  ...
  return (
    <div
      className="absolute inset-0 -z-10 w-full h-full opacity-30 pointer-events-none"
      ref={containerRef} 
    />
  )
}
